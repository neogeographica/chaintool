...
def cli_edit(cmd, print_after_set):
    ...
    try:
        ...
        # conflicts.
        old_cmdline = ""
        cleanup_fun = lambda: item_io.delete_cmd(cmd, True)
...
def cli_del(delcmds, ignore_seq_usage):
    ...
    Delete each command (via :func:`.item_io.delete_cmd`), and tear down its
